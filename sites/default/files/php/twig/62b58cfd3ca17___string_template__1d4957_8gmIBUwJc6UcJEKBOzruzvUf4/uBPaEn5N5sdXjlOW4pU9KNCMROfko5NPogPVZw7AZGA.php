...
class __TwigTemplate_261f22f73407b65cd32c8db402105496b38cb7a72a6c7b54827b4434b04145ad extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        return new Source("{# inline_template_start #}<li><a data-target=\"{{ target|clean_class }}\" class=\"{{active}}\"><span role=\"img\">{% include icon %}</span><div class=\"bs_tooltip\" data-placement=\"bottom\" role=\"tooltip\">{{ title }}</div></a></li>", "__string_template__1d495723f3fb6444e2a82660924999132ec13ce5ff97e15d708cd688b66b4683", "");
    }
